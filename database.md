...
> [!NOTE]
> If you use the [Laravel installer](installation.md#criando-uma-aplicação-laravel) to create your Laravel application and select SQLite as your database, Laravel will automatically create a `database/database.sqlite` file and run the default [database migrations](migrations.md) for you.
