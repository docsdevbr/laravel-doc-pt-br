...
If you are utilizing the `search` or `multisearch` functions provided by [Laravel Prompts](prompts.md), you may use the `expectsSearch` assertion to mock the user's input, search results, and selection:
