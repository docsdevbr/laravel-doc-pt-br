...
When running the `install:broadcasting` command, you will be prompted to install [Laravel Reverb](reverb.md). Of course, you may also install Reverb manually using the Composer package manager.
