...
While your application is in [maintenance mode](configuration.md#modo-de-manutenção), no queued jobs will be handled. The jobs will continue to be handled as normal once the application is out of maintenance mode.
